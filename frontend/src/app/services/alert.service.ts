...
export interface AlertDto {
  ...
  exceptionZoneId?: number | null;
  exceptionWasteType?: string | null;
  exceptionBinIds?: string | null;
}
...
export class AlertService {
  ...
  createExceptionMission(alertId: number): Observable<any[]> {
    return this.http.post<any[]>(`${this.baseUrl}/${alertId}/create-exception-mission`, {});
  }
}
