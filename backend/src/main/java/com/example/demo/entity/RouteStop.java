...
public class RouteStop {
    ...
    public Long getDisposalSiteId() { return disposalSiteId; }
    public void setDisposalSiteId(Long disposalSiteId) { this.disposalSiteId = disposalSiteId; }

    public String getDisposalSiteName() { return disposalSiteName; }
    public void setDisposalSiteName(String disposalSiteName) { this.disposalSiteName = disposalSiteName; }
