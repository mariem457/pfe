...
public interface AlertRepository extends JpaRepository<Alert, Long> {
    ...
    boolean existsByBinIdAndResolvedFalseAndAlertTypeAndSeverity(Long binId, String alertType, String severity);

    boolean existsByEntityTypeAndEntityIdAndAlertTypeAndResolvedFalse(String entityType, Long entityId, String alertType);

    boolean existsByIncidentIdAndAlertTypeAndResolvedFalse(Long incidentId, String alertType);
