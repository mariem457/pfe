...
DEFAULT_MAX_DISTANCE_METERS = get_int("DEFAULT_MAX_DISTANCE_METERS", 50000)
FUEL_SAFETY_FACTOR = get_float("FUEL_SAFETY_FACTOR", 0.8)
MIN_FUEL_RESERVE_LITERS = get_float("MIN_FUEL_RESERVE_LITERS", 5.0)
MIN_REQUIRED_DISTANCE_METERS = get_int("MIN_REQUIRED_DISTANCE_METERS", 1000)
